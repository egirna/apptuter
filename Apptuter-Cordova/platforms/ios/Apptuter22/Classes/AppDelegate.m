...
// uncomment the following lines to enable push notifications //
...
//{
//    [[PushAppsManager sharedInstance] startPushAppsWithAppToken:@"YOUR_PUSHAPPS_APP_TOKEN" withLaunchOptions:launchOptions];
